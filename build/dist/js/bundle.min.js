...
window.addEventListener("load", function () {
    baseClass.loadingFnDoing(config_1.configData['loading'], function () {
        ...
        var bgMusic = audio.init(config_1.configData['audio']['bg']);
        ...
        starVolume = audio.init(config_1.configData['audio']['volue1']['start']);
        endVolume = audio.init(config_1.configData['audio']['volue1']['end']);
