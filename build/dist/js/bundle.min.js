...
exports.__esModule = true;
var configData = {
    loading: ['../media/show.mp4', '../media/ty-music.mp3', '../media/zyx-music.mp3', '../media/coach-timmy__start.aac', '../media/coach-timmy__end.aac', '../img/ava/a1.jpg', '../img/ava/a2.jpg', '../img/ava/a3.jpg', '../img/ava/a4.jpg', '../img/ava/a5.jpg', '../img/ava/a6.jpg', '../img/ava/a7.jpg', '../img/ava/a8.jpg', '../img/ava/a9.jpg', '../img/ava/a10.jpg', '../img/bubble/blue.png', '../img/bubble/green.png', '../img/bubble/heart.png', '../img/bubble/orange.png', '../img/bubble/pink.png', '../img/pro/01.jpg', '../img/pro/02.jpg', '../img/pro/03.jpg', '../img/pro/04.jpg', '../img/pro/05.jpg', '../img/model/Look1.jpg', '../img/model/Look2.jpg', '../img/model/Look3.jpg', '../img/model/Look4.jpg', '../img/model/Look5.jpg', '../img/model/Look6.jpg', '../img/model/Look7.jpg', '../img/model/Look8.jpg', '../img/chat-bag.jpg', '../img/bag.png', '../img/close.png', '../img/icon-msg.png', '../img/icon-share__black.png', '../img/icon-share.png', '../img/icon-volume__black.png', '../img/icon-volume.png', '../img/index-bg.jpg', '../img/logo.png', '../img/poster.jpg', '../img/pro-pop__logo.png', '../img/share-tips.png', '../img/slogan.png', '../img/defaultShare.jpg', '../img/tyShare.jpg', '../img/xwzShare.jpg'],
    video: {
    ...
    audio: {
        ...
        xwz: {
            start: {
                path: '../media/coach-timmy__start.aac',
                isplay: false,
                volume: 1
            },
            end: {
                path: '../media/coach-timmy__end.aac',
                isplay: false,
                volume: 1
            }
        }
    ...
    chat: {
        'xwz': [{
            'avaName': 'a4',
            'text': '大家好，我是许魏洲，我现在在COACH 2018春夏纽约时装周！听到我的声音大家开心吗？喜爱COACH和洲洲的朋友们，我在这里陪你看秀！希望大家多多来互动哦！',
            'time': 1,
            'delay': 2000
        }, {
            'avaName': 'a4',
            ...
            'avaName': 'a4',
            'text': '\u597D\u5566\uFF0C\u966A\u4F34\u5927\u5BB6\u770B\u79C0\u7684\u65F6\u5149\u5C31\u5230\u8FD9\u91CC\u5566\uFF0C\u65F6\u95F4\u8FC7\u5F97\u5F88\u5FEB\uFF0C\u6709\u6CA1\u6709\u5F88\u820D\u4E0D\u5F97\uFF1F\u8FD9\u6B21\u7684COACH 2018\u6625\u590F\u7EBD\u7EA6\u65F6\u88C5\u5468\u771F\u7684\u5F88\u7CBE\u5F69\u3002\u5F88\u5F00\u5FC3\u5927\u5BB6\u548C\u6211\u4E00\u8D77\u5206\u4EAB\u770B\u79C0\u5FC3\u5F97\uFF01\u611F\u8C22\u5927\u5BB6\uFF01\u8BB0\u5F97\u6293\u7D27\u673A\u4F1A\u8D2D\u4E70\u5168\u7403\u9650\u91CF\u90AE\u5DEE\u5305\u54E6~',
            'time': 179,
            'delay': 2000
        }],
        'ty': [{
            'avaName': 'a1',
            'text': '大家好，我是唐嫣！我正在纽约COACH 2018春夏纽约时装周的现场。再次受邀来参加时装周真的超级开心。看看Coach这一季带来什么不一样的新设计呢？',
            'time': 1,
            'delay': 2000
        }, {
            'avaName': 'a1',
    ...
    share: {
        "default": {
            "_title": '唐嫣或许魏洲陪你走进纽约时装周',
            "_desc": "直击秀场，抢先领略COACH全新系列",
            "_desc_friend": "直击秀场，抢先领略COACH全新系列",
            "_link": window.location.origin,
            "_imgUrl": window.location.origin + "/build/dist/img/defaultShare.jpg",
        ...
        ty: {
            ...
            "_desc_friend": "直击秀场，抢先领略COACH全新系列",
            "_link": window.location.origin,
            "_imgUrl": window.location.origin + "/build/dist/img/tyShare.jpg",
            "_shareAppMessageCallback": function _shareAppMessageCallback() {},
            "_shareTimelineCallback": function _shareTimelineCallback() {}
        },
        xwz: {
            ...
            "_desc_friend": "直击秀场，抢先领略COACH全新系列",
            "_link": window.location.origin,
            "_imgUrl": window.location.origin + "/build/dist/img/xwzShare.jpg",
            "_shareAppMessageCallback": function _shareAppMessageCallback() {},
            "_shareTimelineCallback": function _shareTimelineCallback() {}
        }
    }
...
window.addEventListener("load", function () {
    baseClass.loadingFnDoing(config_1.configData['loading'], function () {
        ...
        common.init();
        var showTime = video.init(config_1.configData['video']);
        ...
        var starVolume, endVolume, volumeName;
        for (var i = 0; i < choseVolume.length; i++) {
            choseVolume[i].addEventListener("click", function (e) {
                ...
                starVolume = audio.init(config_1.configData['audio'][volumeName]['start']);
                endVolume = audio.init(config_1.configData['audio'][volumeName]['end']);
                showTime.play();
                baseClass.sectionChange("showTime");
                bubbleFun();
                starVolume.play();
                audio.eventTester(starVolume, 'play', function () {
                    video.setVolume(showTime, 0.6);
                });
                audio.eventTester(starVolume, 'ended', function () {
                    video.setVolume(showTime, 1);
                });
                audio.eventTester(endVolume, 'play', function () {
                    video.setVolume(showTime, 0.6);
                });
                audio.eventTester(endVolume, 'ended', function () {
                    video.setVolume(showTime, 1);
                });
                e.preventDefault();
            });
        ...
        iconVolume.addEventListener("click", function () {
            if (!starVolume) return false;
            if (V(this).hasClass('off')) {
                this.className = 'icon-volume';
                audio.setMuted(starVolume, false);
                audio.setMuted(endVolume, false);
                video.setVolume(showTime, 0.6);
            } else {
                this.className += ' off';
                audio.setMuted(starVolume, true);
                audio.setMuted(endVolume, true);
                video.setVolume(showTime, 1);
            }
        });
        ...
        video.eventTester(showTime, 'timeupdate', function () {
            var time = parseInt(showTime.currentTime),
                duration = parseInt(showTime.duration);
            var timeline = config_1.configData['model']['timeline'],
                xwzChatLine = config_1.configData['chat'][volumeName],
                endDuration = parseInt(showTime.duration) - parseInt(endVolume.duration) + 2;
            console.log(volumeName, time, duration, endDuration);
