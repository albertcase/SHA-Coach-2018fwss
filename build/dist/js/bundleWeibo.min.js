...
window.addEventListener("load", function () {
    baseClass.loadingFnDoing(config_1.configData['loading'], function () {
        ...
        var starVolume, endVolume;
        for (var i = 0; i < choseVolume.length; i++) {
            choseVolume[i].addEventListener("click", function (e) {
                var volumeId = this.getAttribute('data-id');
                starVolume = audio.init(config_1.configData['audio'][volumeId]['start']);
                endVolume = audio.init(config_1.configData['audio'][volumeId]['end']);
